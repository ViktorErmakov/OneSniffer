...
- Use **search_in_code** to understand existing patterns
- Use **get_metadata_objects** / **get_metadata_details** to map current metadata structure
- Use **search_in_code** to find architectural examples
...
Key tools: **get_metadata_objects**, **get_metadata_details**, **search_in_code**, **graph_dependencies**, **search_in_code**, **helpsearch**, **business_search**, **answer_metadata_question**
