...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПоказыватьСодержимое = Ложь;
	
КонецПроцедуры

&НаКлиенте
Процедура ПриОткрытии(Отказ)
	УстановитьРежимОтображенияПароля();
КонецПроцедуры
...
&НаКлиенте
Процедура ПоказыватьСодержимоеПриИзменении(Элемент)
	УстановитьРежимОтображенияПароля();
КонецПроцедуры
...
&НаКлиенте
Процедура УстановитьРежимОтображенияПароля()
	
	Элементы.ДешифрованныйТекст.РежимПароля = Не ПоказыватьСодержимое;
