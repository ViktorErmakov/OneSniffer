...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//TODO запустить фз по чтению ЖР на предмет исключений.
	// Проверка использования.
	НастройкиЛогирования = ЛогированиеТрафика.ЗагрузитьНастройкиЛогирования();
	Если НастройкиЛогирования.ВключеноЛогирование Тогда
		...
		Для Каждого СтрокаЗаписиЖР Из ТаблицаЗаписей Цикл
			...
			СохраненныйЛогЗапроса = ЛогированиеТрафика.ЗначениеИзСтрокиJSON(СтрокаЗаписиЖР.Данные, "Дата"); // см. РегистрыСведений.ЛогиТрафика.НовыйЛогЗапроса
