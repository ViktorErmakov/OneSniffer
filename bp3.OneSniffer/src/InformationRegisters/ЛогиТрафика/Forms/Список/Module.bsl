...
Процедура ТестовыйЗапрос(Команда)
	...
	ТекстЗапроса = "### ЛогированиеТрафика.ПроизвольныйЗапрос
...
&НаСервере
Процедура ПрочитатьИсключенияИзЖР()
	
	НастройкиЛогирования = ЛогированиеТрафика.ЗагрузитьНастройкиЛогирования();
	Если НастройкиЛогирования.Свойство("ВключеноЛогирование") И НастройкиЛогирования.ВключеноЛогирование
		И НастройкиЛогирования.Свойство("ПолучениеИсключенийВключено") И НастройкиЛогирования.ПолучениеИсключенийВключено Тогда
		
		Если НастройкиЛогирования.Свойство("ПолучатьИсключенияФЗ") И НастройкиЛогирования.ПолучатьИсключенияФЗ Тогда
			ДлительнаяОперацияИсключенияЖР = ЛогированиеТрафика.ЗаписатьИсключенияВРСВФоне();
		Иначе
			ЛогированиеТрафика.ЗаписатьИсключенияВРС();
		КонецЕсли;
