...
Функция _ВызватьHTTPМетод(Знач Соединение, Знач Метод, Знач Запрос, Знач ИмяВыходногоФайла, ИмяСобытия = "") Экспорт
	...
	ЗаписыватьВЖРТело = НастройкиЛогирования.ЗаписыватьВЖРТело;
	
	ЛогЗапроса = РегистрыСведений.ЛогиТрафика.ЛогЗапроса(Соединение, Запрос, Метод, ЗаписыватьВЖРТело, ИмяСобытия);
