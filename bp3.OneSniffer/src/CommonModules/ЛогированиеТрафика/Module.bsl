...
Процедура СохранитьНастройкиЛогирования(Настройки) Экспорт
	...
	ПолныеНастройки = НовыеНастройкиЛогирования();
...
Процедура ВыполнитьЗапросHTTP(СтрокаЗапроса, КэшОтветов, КлючЗаписиЛога, Отказ, ТекстОшибки)
	...
	Соединение = НовоеHTTPСоединениеПоПараметрам(ПротоколЗапроса, ТекстОшибки);
...
Функция НовоеHTTPСоединениеПоПараметрам(ПараметрыЗапроса, ТекстОшибки = """");
...
Функция ДанныеДляЗаписиИсключения(ЛогЗапроса) Экспорт
	...
	ДанныеДляСериализации = РегистрыСведений.ЛогиТрафика.СтруктураМенеджераЗаписи();
