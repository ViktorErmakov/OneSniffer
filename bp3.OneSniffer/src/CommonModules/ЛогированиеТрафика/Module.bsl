...
Процедура СохранитьНастройкиЛогирования(Настройки) Экспорт
	...
	Если ТипЗнч(Настройки) = Тип("Структура") Тогда
		ЗаполнитьЗначенияСвойств(ПолныеНастройки, Настройки);
	КонецЕсли;
...
Функция СостояниеРегламентногоЗаданияОчистки() Экспорт
	...
	Иначе
		Результат.Описание = НСтр(
			"ru = 'Регламентное задание отключено. Включите флажок или настройте в карточке задания.'");
	КонецЕсли;
...
// Устанавливает признак использования регламентного задания очистки.
//
// Параметры:
//  Использование - Булево
//
Процедура УстановитьИспользованиеРегламентногоЗаданияОчистки(Использование) Экспорт
...
// Запускает регламентное задание очистки вне очереди.
//
// Возвращаемое значение:
//  Структура - см. РегламентныеЗаданияСлужебный.ВыполнитьРегламентноеЗаданиеВручную
//
Функция ВыполнитьРегламентноеЗаданиеОчисткиСейчас() Экспорт
	...
	Возврат МодульРегламентныеЗаданияСлужебный.ВыполнитьРегламентноеЗаданиеВручную(Идентификатор);
