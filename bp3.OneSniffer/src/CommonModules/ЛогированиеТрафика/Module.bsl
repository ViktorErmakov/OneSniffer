...
// 	Произвольный
//
Функция ЗначениеИзСтрокиJSON(Знач Значение) Экспорт
...
//		Ответ = ВызватьHTTPМетодРасширенный(Соединение, Запрос, ПротоколЗапроса.Метод, ПротоколЗапроса.Событие,, КлючЗаписиЛога);
