...
Функция ЗаписатьИсключенияВРС() Экспорт
	...
	Если КонстантаСуществует <> Неопределено Тогда
...
Функция ПодготовитьЛог(ЛогЗапроса, Назначение) Экспорт
	...
	ДополнитьЛогДаннымиОтвета(Результат, ЛогЗапроса, Настройки);
...
Процедура ДополнитьЛогДаннымиОтвета(Результат, ЛогЗапроса, Настройки)
